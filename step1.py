...
# with command line options: CloseByParticle_Photon_ERZRanges_cfi -s GEN,SIM -n 10 --conditions auto:phase2_realistic_T33 --beamspot HGCALCloseBy --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry Extended2026D110 --era Phase2C17I13M9 --relval 9000,100
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step1_pion.root'),
...
particle=211
# photon 22 pion+ 211 nutrino 14 muon 13
eMin=149
# energy
eMax=151
etaMin=2.09
...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        VarMax = cms.double(eMax),
        VarMin = cms.double(eMin),
